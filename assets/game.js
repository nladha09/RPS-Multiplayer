// Initialize Firebase
var config = {
    apiKey: "AIzaSyDzu3fkxzDN-pBohxwi9F56Uen-hSxSmGE",
    authDomain: "rps-multiplayer-4a3c0.firebaseapp.com",
    databaseURL: "https://rps-multiplayer-4a3c0.firebaseio.com",
    projectId: "rps-multiplayer-4a3c0",
    storageBucket: "rps-multiplayer-4a3c0.appspot.com",
    messagingSenderId: "866792745336"
};
...
chat.on("child_added", function (snap) {
    ...
    $("#message-view").animate({
        scrollTop: $("#message-view")[0].scrollHeight
    }, 500);
});
